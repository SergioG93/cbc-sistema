$('#tableAlumnos2').DataTable();
var tableAlumnos2;

document.addEventListener('DOMContentLoaded',function(){
    tableAlumnos2 = $('#tableAlumnos2').DataTable({
        "aProcessing": true,
        "aServerSide": true,
        "language": {
        ...
        "ajax": {
            "url": "./models/alumnos/table_alumnos_segundo.php",
            "dataSrc":""
        },
        "columns": [
            {"data":"alumno_id"},
    ...
    formALumnos.onsubmit = function(e) {
        ...
        if(nombre == '' || apellido == '' || edad == '' || direccion == '' || cedula == '' || telefono == '' || email == '' || fechaNac == '' || status == '' || grado == '') {
            ...
            request.onreadystatechange = function() {
                if(request.readyState == 4 && request.status == 200) {
                    if(request.status) {
                        ...
                        document.querySelector('#listgrado').value = objData.data.estatus;
