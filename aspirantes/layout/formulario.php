            ...
            <div class="row">
                  <div class="col-12 col-md-6 col-lg-6 ">
                     <span class="text-muted small-font">Nombre del Padre o Tutor</span>
                        <input type="text" name="nomAp" class="form-control" placeholder="Nombre del Padre o Tutor " maxlength="50" required>
                  ...
                  <div class="col-12 col-md-6 col-lg-6 ">
                     <span class="text-muted small-font">Apellidos</span>
                        <input type="text" name="nomAp1" class="form-control" placeholder="Apellidos " maxlength="80" required>
...
<hr>
            ...
            <div class="row">
                  ...
                  <input type="text" class="form-control"  placeholder="Nombre de la Madre" maxlength="50" required="" name="nomAp2">
      
                  </div>
                  
                  <div class="col-12 col-md-6 col-lg-6 ">
                  <span class="text-muted small-font">Apellidos</span>
                  <input type="text" class="form-control"  placeholder="Apellidos" maxlength="80" required="" name="nomAp22">
