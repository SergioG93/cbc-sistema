<?php
    ...
    if (!isset($_SESSION['numeroFolio'])) //si no hay algo almacenado en $_SESSION["usuario"] entonces se dirige a la
        ...
        $sql = "SELECT Nombre,Nombres,Apellido_Paterno,Apellido_Materno,Fecha_Nacimiento,Mes_Nacimiento,An_Nacimiento,Lugar_Nacimiento,Nacionalidad,Edad_A_Septiembre,Escuela_Procedencia,Religion,Telefono_Fijo,Telefono_Movil,Correo,Calle,Numero_Ext,Numero_Int,CP,Fraccionamiento,Nivel_A_Ingresar,Grado_A_Ingresar,Nombre_Tutor,Tel_Tutor,Trabajo,Profesion,Madre,Tel_M,Trabajo_M,Profesion_M,HermanoA,GradoA,HermanoB,GradoB,Referencias,Nivel_A_Ingresar,Grado_A_Ingresar,NivelA,NivelB FROM aspirantes WHERE Folio='$folios'";
...
<body>
  <p>Folio:<?php echo " " . $folios;?> </p>
  <div class="row">

    <div class="col-md-12 order-md-1">
      <form class="needs-validation"  id="regiration_form" action="" method="post" novalidate>
       ...
       <h4 class="mb-3">I.- Datos del Alumno</h4>
         <div class="row">
               ...
               <div class="col-md-4 mb-3">
                  ...
                  <input type="text" class="form-control" name="ap" id="apellidop" placeholder=""  maxlength="25" minlength="2" pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,48}" required value="<?php echo $d2;?>">
               ...
               <div class="col-md-4 mb-3">
                  ...
                  <input type="text" class="form-control" name="am" id="apellidom" placeholder=""  maxlength="25" minlength="2" pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,48}" required value="<?php echo $d3;?>">
         ...
         <div class="row">
               ...
               <div class="col-md-3 mb-3">
                     ...
                     <input type="text" class="form-control"name="fechaN" id=""  maxlength="25" minlength="2" value="<?php echo $d4;?>" required>
                        <div class="invalid-feedback">
                        es requerido.
                        </div>
               </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                     ...
                     <input type="text" class="form-control" id="edadasept" placeholder="" required maxlength="100" minlength="2" value="<?php echo $d9;?>" name="edadasept" required>
            ...
            <div class="row">
               <div class="col-md-3 mb-3">
                     ...
                     <input type="text" class="form-control" name="nPP" id="Name" maxlength="25" minlength="2" pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,48}" value="<?php echo $d22;?>" required>
                        <div class="invalid-feedback">
                        Nombre es requerido.
                        </div>
               </div>
         ...
         <hr class="mb-4">
            ...
            <div class="row">
               <div class="col-md-3 mb-3">
                     ...
                     <input type="text" class="form-control" name="nMM" id="" placeholder="" maxlength="25" minlength="2" pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,48}" value="<?php echo $d26;?>" required="">
                        <div class="invalid-feedback">
                        Es requerido.
                        </div>
               </div>
        ...
        <label for="">Tiene Hermanos en el Colegio ?</label>
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                     ...
                     <input type="text" class="form-control" name="he1" id="firstName" placeholder="" maxlength="25" minlength="2" pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,48}" value="<?php echo $d30;?>">
                        <div class="invalid-feedback">
               ...
               <div class="col-md-4 mb-3">
                     ...
                     <input type="text" class="form-control"name="ne1" id=""  maxlength="25" minlength="2" value="<?php echo $d37;?>" required>
                        <div class="invalid-feedback">
                        es requerido.
                        </div>
               </div>
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                     ...
                     <input type="text" class="form-control"  name="he2" id="" maxlength="25" minlength="2" pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,48}" value="<?php echo $d32;?>">
                        <div class="invalid-feedback">
                        El Nombre es Requerido.
                        </div>
               </div>
               ...
               <div class="col-md-4 mb-3">
                     <label for="">Nivel de Estudio</label>
                     <input type="text" class="form-control"name="ne2" id=""  maxlength="25" minlength="2" value="<?php echo $d38;?>" required>
                        <div class="invalid-feedback">
                        es requerido.
                        </div>
               </div>
...
<!--
            ...
            <div class="row">
                  <div class="col-md-5 mb-1">
                     ...
                     <input type="text" class="form-control" id="" placeholder="" value="" pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,48}" name="f1" maxlength="15" minlength="2">
                        <div class="invalid-feedback">
                        El Nombre es Requerido.
                        </div>
                  </div>
            ...
            <div class="row">
                  <div class="col-md-5 mb-1">
                     ...
                     <input type="text" class="form-control" id="" placeholder="" value="" name="f2" maxlength="15" minlength="2" pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,48}">
                        <div class="invalid-feedback">
                        El Nombre es Requerido.
                        </div>
                  </div>
            ...
            <div class="row">
                  <div class="col-md-5 mb-1">
                     ...
                     <input type="text" class="form-control" id="" placeholder="" value="" name="f3" maxlength="15" minlength="2" pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,48}">
                        <div class="invalid-feedback">
                        El Nombre es Requerido.
                        </div>
                  </div>
          ...
          if (isset($_POST['boton']))     //si se presiono el boton  enviar                           {
            {
                ...
                //$domicilio = strtoupper($_POST["calle"]) . " Num: " . $_POST["nE"] . " CP: " . $_POST["cp"] . " Col/Frac: " . $_POST["frac"];   //domicilio
                $domicilio = strtoupper($_POST["domicilio"]);  //domicilio
                ...
                $gradoB = strtoupper($_POST["gr2"]);    //grado 2
                 ...
                 $formaEscolar = strtoupper($_POST["combopagoReg"]);  //forma de escolar
                 $formaPago = strtoupper($_POST["comboPag"]);  //forma de pago
                 $formaUniforme = strtoupper($_POST["comboUni"]);  //forma de uniforme
                ...
                inscrito($folios);   //actualiza Actividad=INSCRITO para que no entre al formulario 2
                insertaDatosInscripcion($nombreCompleto,$nombre,$apellidoP,$apellidoM,$lugarnacimiento,$nacionalidad,$fechaN,$mes,$an,$reli,$ck,$ca,$domicilio,$nombrepapa,$edadP,$estadoCivilP,$religionP,$domicilioP,$telpapa,$profesionPapa,$trabajoPapa,$puestoPapa, $telefonoTrabajoPapa,$correoPapa,$telefonoMovilPapa,$nombremama,$edadM,$estadoCivilM,$religionM,$domicilioM,$telmama,$profesionMama,$trabajoMama,$puestoMama,$telefonoTrabajoMama,$correoMama,$telefonoMovilMama,$hermanoA,$nivelhA,$gradoA,$hermanoB,$nivelhB,$gradoB,$referencia1,$parentesco1,$telefono1,$referencia2,$parentesco2,$telefono2,$referencia3,$parentesco3,$telefono3,$enfermedad,$medicamento,$alergia,$tipoPago,$formaEscolar,$formaPago,$formaUniforme,$fechaInscripcion,$Mont,$Year,$nivel,$gr,$estatus);
