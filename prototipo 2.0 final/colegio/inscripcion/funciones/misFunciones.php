<?php
        ...
        function InsertaDatosAspirante($nombreCompleto,$nombre,$apellidoP,$apellidoM,$fNacimineto,$fn,$mes,$aaaa,$lNacimineto,$nacionalidad,$edadReal,$escuelaProcedencia,$religion,$telFijo,$telMovil,$correoA,$fecharegistro,$Mont,$Year,$calle,$numE,$numI,$codigoPostal,$fracColonia,$localidad,$nivel,$nGrado,$nombreTutor,$tutorTM,$tutorProfesion,$tutorTrabajo,$nombreMadre,$telMadre,$profesionMadre,$trabajoMadre,$h1,$g1,$h2,$g2,$ref1)
        {
            include("datosConexion.php");
            $conexion = mysqli_connect($db_host,$db_usuario,$db_password,$db_nombreBD);  //cadena de coneccion
            if(mysqli_connect_errno())     //encaso de error al conectara la base de datos
            ...
            $consulta="INSERT INTO aspirantes (Folio,Nombre,Nombres,Apellido_Paterno,Apellido_Materno,Fecha_Nacimiento,FN,Mes_Nacimiento,An_Nacimiento,Lugar_Nacimiento,Nacionalidad,Edad_A_Septiembre,Escuela_Procedencia,Religion,Telefono_Fijo,Telefono_Movil,Correo,Fecha_Registro,Mes_Registro,An_Registro,Calle,Numero_Ext,Numero_Int,CP,Fraccionamiento,Localidad,Nivel_A_Ingresar,Grado_A_Ingresar,Nombre_Tutor,Tel_Tutor,Profesion,Trabajo,Madre,Tel_M,Profesion_M,Trabajo_M,HermanoA,GradoA,HermanoB,GradoB,Referencias,Actividad) VALUES ('".$folio."','".$nombreCompleto."','".$nombre."','".$apellidoP."','".$apellidoM."','".$fNacimineto."','".$fn."','".intval($mes)."','".intval($aaaa)."','".$lNacimineto."','".$nacionalidad."','".$edadReal."','".$escuelaProcedencia."','".$religion."','".$telFijo."','".$telMovil."','".$correoA."','".$fecharegistro."','".intval($Mont)."','".intval($Year)."','".$calle."','".$numE."','".$numI."','".$codigoPostal."','".$fracColonia."','".$localidad."','".$nivel."','".$nGrado."','".$nombreTutor."','".$tutorTM."','".$tutorProfesion."','".$tutorTelTrabajo."','".$nombreMadre."','".$telMadre."','".$profesionMadre."','".$trabajoMadre."','".$h1."','".$g1."','".$h2."','".$g2."','".$ref1."','".$actividad."')";    
       ...
       function userlogIn($user,$clave): int
       {
        ...
        function insertaDatosInscripcion($nombreCompleto,$nombre,$apellidoP,$apellidoM,$lugarnacimiento,$nacionalidad,$fechaN,$mes,$an,$religion,$ck,$ca,$domicilio,$nombrepapa,$edadP,$estadoCivilP,$religionP,$domicilioP,$telpapa,$profesionPapa,$trabajoPapa,$puestoPapa, $telefonoTrabajoPapa,$correoPapa,$telefonoMovilPapa,$nombremama,$edadM,$estadoCivilM,$religionM,$domicilioM,$telmama,$profesionMama,$trabajoMama,$puestoMama,$telefonoTrabajoMama,$correoMama,$telefonoMovilMama,$hermanoA,$gradoA,$hermanoB,$gradoB,$referencia1,$parentesco1,$telefono1,$referencia2,$parentesco2,$telefono2,$referencia3,$parentesco3,$telefono3,$enfermedad,$medicamento,$alergia,$tipoPago,$formaEscolar,$formaPago,$formaUniforme,$fechaInscripcion,$Mont,$Year,$nivel,$grado,$estatus)
        {
            ...
            {  
              ...
              echo "<script>alert('Su registro fue correcto...!);window.location='http://colegiobc.com';</script>";
              exit;
        ...
        //************************************************************************************************
        //funcion para loguera a la inscripcion en linea de un alumno regular
        function logIn2($mat,$ape): int
        {
            include("datosConexion.php");
            $existe=0;
            $estatus="ACTIVO";
            ...
            $sql = "SELECT Nombre,Estatus FROM colegiobc WHERE Matricula='".$mat."' And Apellido_Paterno='".$ape."'"; 
            $r = mysqli_query($conexion,$sql); //se ejecuta la consulta sql en la base de datos y se guarda en $r
            mysqli_close($conexion);  //se cierra la conexion
            if (!$r) 
                {
                    echo"<script>alert('Matricula o Apellido son incorrectos...!'); window.location='./index.php';</script>";  
                    exit;
                }
            while($lastname =mysqli_fetch_assoc($r))
                {
    ...
    //***********************************************************************************************//
        //funcion que inserta los datos de inscripciopn a la tabla 'colegiobc' de la base de datos 'colegiobct'  
        function actualizaDatosInscripcion($nombre,$lugarnacimiento,$nacionalidad,$fechaN,$mes,$an,$religion,$ck,$ca,$domicilio,$nombrepapa,$edadP,$estadoCivilP,$religionP,$domicilioP,$telpapa,$profesionPapa,$trabajoPapa,$puestoPapa, $telefonoTrabajoPapa,$correoPapa,$telefonoMovilPapa,$nombremama,$edadM,$estadoCivilM,$religionM,$domicilioM,$telmama,$profesionMama,$trabajoMama,$puestoMama,$telefonoTrabajoMama,$correoMama,$telefonoMovilMama,$hermanoA,$gradoA,$hermanoB,$gradoB,$referencia1,$parentesco1,$telefono1,$referencia2,$parentesco2,$telefono2,$referencia3,$parentesco3,$telefono3,$enfermedad,$medicamento,$alergia,$tipoPago,$formaEscolar,$formaPago,$formaUniforme,$fechaInscripcion,$Mont,$Year,$nivel,$grado,$estatus,$matricula)
        {
            ...
            //inserta los datos a la base de datos en la tabla 'asirantes'
            $consulta="UPDATE colegiobc SET Nombre='$nombre',Lugar_Nacimiento='$lugarnacimiento',Nacionalidad='$nacionalidad',Fecha_Nacimiento='$fechaN',Mes_Nacimiento='$mes',An_Nacimiento='$a.',Religion='$religion',Clave_Catastral='$ck',Cuenta_Agua='$ca',Domicilio='$domicilio',Nombre_Padre='$nombrepapa',Edad_Padre='$edadP',Estado_Civil_Padre='$estadoCivilP',Religion_Padre='$religionP',Domicilio_Padre='$domicilioP',Telefono_Padre='$telpapa',Profesion_Padre='$profesionPapa',Empresa_Trabajo_Padre='$trabajoPapa',Puesto_Padre='$puestoPapa',Telefono_Oficina_Padre='$telefonoTrabajoPapa',Correo_Padre='$correoPapa',Tel_Movil_Padre='$telefonoMovilPapa',Nombre_Madre='$nombremama',Edad_Madre='$edadM',Estado_Civil_Madre='$estadoCivilM',Religion_Madre='$religionM',Domicilio_Madre='$domicilioM',Telefono_Madre='$telmama',Profesion_Madre='$profesionMama',Trabajo_Madre='$trabajoMama',Puesto_Madre='$puestoMama',Telefono_Oficina_Madre='$telefonoTrabajoMama',Correo_Madre='$correoMama',Tel_Movil_Madre='$telefonoMovilMama',HermanoA='$hermanoA',GradoA='$gradoA',HermanoB='$hermanoB',GradoB='$gradoB',Nombre_EmgA='$referencia1',ParentescoA='$parentesco1',TelefonoEA='$telefono1',Nombre_EmgB='$referencia2',ParentescoB='$parentesco2',TelefonoEB='$telefono2',Nombre_EmgC='$referencia3',ParentescoC='$parentesco3',TelefonoEC='$telefono3',Padecimiento='$enfermedad',Medicamento='$medicamento',Alergia_A_Medicamento='$alergia',Tipo_Pago='$tipoPago',Reglamento_Escolar='$formaEscolar',Reglamento_Pagos='$formaPago',Reglamento_Uniformes='$formaUniforme',Fecha_Inscripcion='$fechaInscripcion',Mes_Inscripcion='$Mont',An_Inscripcion='$Year',Nivel='$nivel',Grado='$grado',Estatus='$estatus' WHERE Matricula='$matricula')";    
      ...
      function actualizaDatosInscripcion2($nombre,$lugarnacimiento,$nacionalidad,$fechaN,$religion,$ck,$ca,$domicilio,$nombrepapa,$edadP,$estadoCivilP,$religionP,$domicilioP,$telpapa,$profesionPapa,$trabajoPapa,$puestoPapa, $telefonoTrabajoPapa,$correoPapa,$telefonoMovilPapa,$nombremama,$edadM,$estadoCivilM,$religionM,$domicilioM,$telmama,$profesionMama,$trabajoMama,$puestoMama,$telefonoTrabajoMama,$correoMama,$telefonoMovilMama,$hermanoA,$gradoA,$hermanoB,$gradoB,$referencia1,$parentesco1,$telefono1,$referencia2,$parentesco2,$telefono2,$referencia3,$parentesco3,$telefono3,$enfermedad,$medicamento,$alergia,$tipoPago,$formaEscolar,$formaPago,$formaUniforme,$fechaInscripcion,$Mont,$Year,$nivel,$grado,$estatus,$matricula)
        {
            ...
            //inserta los datos a la base de datos en la tabla 'asirantes'
            $consulta="UPDATE colegiobc SET Nombre='$nombre',Lugar_Nacimiento='$lugarnacimiento',Nacionalidad='$nacionalidad',Fecha_Nacimiento='$fechaN',Religion='$religion',Clave_Catastral='$ck',Cuenta_Agua='$ca',Domicilio='$domicilio',Nombre_Padre='$nombrepapa',Edad_Padre='$edadP',Estado_Civil_Padre='$estadoCivilP',Religion_Padre='$religionP',Domicilio_Padre='$domicilioP',Telefono_Padre='$telpapa',Profesion_Padre='$profesionPapa',Empresa_Trabajo_Padre='$trabajoPapa',Puesto_Padre='$puestoPapa',Telefono_Oficina_Padre='$telefonoTrabajoPapa',Correo_Padre='$correoPapa',Tel_Movil_Padre='$telefonoMovilPapa',Nombre_Madre='$nombremama',Edad_Madre='$edadM',Estado_Civil_Madre='$estadoCivilM',Religion_Madre='$religionM',Domicilio_Madre='$domicilioM',Telefono_Madre='$telmama',Profesion_Madre='$profesionMama',Trabajo_Madre='$trabajoMama',Puesto_Madre='$puestoMama',Telefono_Oficina_Madre='$telefonoTrabajoMama',Correo_Madre='$correoMama',Tel_Movil_Madre='$telefonoMovilMama',HermanoA='$hermanoA',GradoA='$gradoA',HermanoB='$hermanoB',GradoB='$gradoB',Nombre_EmgA='$referencia1',ParentescoA='$parentesco1',TelefonoEA='$telefono1',Nombre_EmgB='$referencia2',ParentescoB='$parentesco2',TelefonoEB='$telefono2',Nombre_EmgC='$referencia3',ParentescoC='$parentesco3',TelefonoEC='$telefono3',Padecimiento='$enfermedad',Medicamento='$medicamento',Alergia_A_Medicamento='$alergia',Tipo_Pago='$tipoPago',Reglamento_Escolar='$formaEscolar',Reglamento_Pagos='$formaPago',Reglamento_Uniformes='$formaUniforme',Fecha_Inscripcion='$fechaInscripcion',Mes_Inscripcion='$Mont',An_Inscripcion='$Year',Nivel='$nivel',Grado='$grado',Estatus='$estatus' WHERE Matricula='$matricula')";    
       ...
       function actualizaDatosInscripcionX($nombreCompleto,$nombre,$apellidoP,$apellidoM,$lugarnacimiento,$nacionalidad,$nivel,$grado,$domicilio,$rel,$ck,$ca,$nombrepapa,$edadP,$estadoCivilP,$religionP,$domicilioP,$telpapa,$profesionPapa,$trabajoPapa,$puestoPapa,$telefonoTrabajoPapa,$correoPapa,$telefonoMovilPapa,$nombremama,$edadM,$estadoCivilM,$religionM,$domicilioM,$telmama,$profesionMama,$trabajoMama,$puestoMama,$telefonoTrabajoMama,$correoMama,$telefonoMovilMama,$hermanoA,$gradoA,$hermanoB,$gradoB,$referencia1,$parentesco1,$telefono1,$referencia2,$parentesco2,$telefono2,$referencia3,$parentesco3,$telefono3,$enfermedad,$medicamento,$alergia,$tipoPago,$formaEscolar,$formaPago,$formaUniforme,$fechaInscripcion,$Mont,$Year,$fechaNacimiento,$curp,$matricula)
        {
            ...
            $consulta="UPDATE colegiobc SET Nombre='$nombreCompleto',Nombres='$nombre',Apellido_Paterno='$apellidoP',Apellido_Materno='$apellidoM',Lugar_Nacimiento='$lugarnacimiento',Nacionalidad='$nacionalidad',Nivel='$nivel',Religion='$rel',Clave_Catastral='$ck',Cuenta_Agua='$ca',Grado='$grado',Domicilio='$domicilio',Nombre_Padre='$nombrepapa',Edad_Padre='$edadP',Estado_Civil_Padre='$estadoCivilP',Religion_Padre='$religionP',Domicilio_Padre='$domicilioP',Telefono_Padre='$telpapa',Profesion_Padre='$profesionPapa',Empresa_Trabajo_Padre='$trabajoPapa',Puesto_Padre='$puestoPapa',Telefono_Oficina_Padre='$telefonoTrabajoPapa',Correo_Padre='$correoPapa',Tel_Movil_Padre='$telefonoMovilPapa',Nombre_Madre='$nombremama',Edad_Madre='$edadM',Estado_Civil_Madre='$estadoCivilM',Religion_Madre='$religionM',Domicilio_Madre='$domicilioM',Telefono_Madre='$telmama',Profesion_Madre='$profesionMama',Trabajo_Madre='$trabajoMama',Puesto_Madre='$puestoMama',Telefono_Oficina_Madre='$telefonoTrabajoMama',Correo_Madre='$correoMama',Tel_Movil_Madre='$telefonoMovilMama',HermanoA='$hermanoA',GradoA='$gradoA',HermanoB='$hermanoB',GradoB='$gradoB',Nombre_EmgA='$referencia1',ParentescoA='$parentesco1',TelefonoEA='$telefono1',Nombre_EmgB='$referencia2',ParentescoB='$parentesco2',TelefonoEB='$telefono2',Nombre_EmgC='$referencia3',ParentescoC='$parentesco3',TelefonoEC='$telefono3',Padecimiento='$enfermedad',Medicamento='$medicamento',Alergia_A_Medicamento='$alergia',Tipo_Pago='$tipoPago',Reglamento_Escolar='$formaEscolar',Reglamento_Pagos='$formaPago',Reglamento_Uniformes='$formaUniforme',Fecha_Inscripcion='$fechaInscripcion',Mes_Inscripcion='$Mont',An_Inscripcion='$Year',Fecha_Nacimiento='$fechaNacimiento',Curp='$curp' WHERE Matricula='$matricula'";    
