            ...
            echo ' <tr>
                    ...
                    <td>
                      ...
                      <div class="btn-group">
                        ...
                        <button class="btn btn-danger btnEliminarAspirante" idAspirante="'.$value["Id"].'"><i class="fa fa-times"></i></button>
...
<?php
					if($_SESSION["perfil"] == "Administrador"){
  $borrarAspirante = new ControladorAspirantes();
  $borrarAspirante -> ctrBorrarAspirante();
}
?>
